...
INSERT public.appointments (id, name, email, phone, preferred_date, preferred_time, service_type, message, status, created_at) FROM stdin;
...
INSERT public.blog_posts (id, title, slug, excerpt, content, author, category, image_url, is_published, published_at, created_at, updated_at) FROM stdin;
...
INSERT public.contacts (id, name, email, phone, subject, message, preferred_date, preferred_time, status, created_at) FROM stdin;
...
INSERT public.documents (id, user_id, name, type, object_path, status, uploaded_at, reviewed_at, review_notes) FROM stdin;
...
INSERT public.newsletters (id, email, subscribed_at, is_active) FROM stdin;
...
INSERT public.sessions (sid, sess, expire) FROM stdin;
...
INSERT public.users (id, email, first_name, last_name, profile_image_url, created_at, updated_at) FROM stdin;
...
INSERT public.whitepapers (id, title, description, author, file_url, download_count, is_published, created_at) FROM stdin;
